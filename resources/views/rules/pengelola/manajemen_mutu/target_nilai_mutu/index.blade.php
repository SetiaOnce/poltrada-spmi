...
@include('rules.pengelola.manajemen_mutu.target_nilai_mutu.form')
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Manajemen Target Nilai Mutu</h4>
                    ...
                    <table class="table table-bordered nowrap datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            <!-- <tr>
                                ...
                                <td>Contoh Unit Prodi 1</td>
                                <td>4</td>
                                <td>Lorem ipsum, atau ringkasnya lipsum, adalah teks standar yang ditempatkan untuk mendemostrasikan elemen grafis atau presentasi.....</td>
...
@section('js')
    @include('rules.pengelola.manajemen_mutu.target_nilai_mutu.script')
@stop
