...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Nama Survey</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Data Nama Survey</li>
                </ol>
            </div>
...
@include('rules.pengelola.manajemen_survey.data_jenis_survey.form')
...
@section('js')
      @include('rules.pengelola.manajemen_survey.data_jenis_survey.script')
@stop
