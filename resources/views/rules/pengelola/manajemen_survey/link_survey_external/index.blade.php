...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Link Survey External</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Link Survey External</li>
                </ol>
            </div>
...
@include('rules.pengelola.manajemen_survey.link_survey_external.form')
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Manajemen Data Nama Survey</h4>
...
@section('js')
      @include('rules.pengelola.manajemen_survey.link_survey_external.script')
@stop
