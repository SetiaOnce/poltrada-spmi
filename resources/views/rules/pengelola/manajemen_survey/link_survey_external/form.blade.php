        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-data" class="form" onsubmit="return false">
                    ...
                    <div class="row mb-3">
                        <label class="form-label">Nama Link Survey : </label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="nama_link_survey" id="nama_link_survey" placeholder="Masukkan nama link survey...">
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="link_url" id="link_url" placeholder="Masukkan nama link url...">
                        </div>
                        <span class="text-mute" style="font-size:12px;"><span class="text-danger">*)</span> Harus diisi! | Contoh Input : <span class="text-info">https://bit.ly/SurveiKepuasanTaruna2023</span></span>
                    </div>
                    <div class="mb-3">
