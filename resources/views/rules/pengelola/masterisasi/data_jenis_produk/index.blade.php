...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Data Jenis Produk</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Data Jenis Produk</h4>
...
@include('rules.pengelola.masterisasi.data_jenis_produk.modal')

@section('js')
    @include('rules.pengelola.masterisasi.data_jenis_produk.script');
@stop
