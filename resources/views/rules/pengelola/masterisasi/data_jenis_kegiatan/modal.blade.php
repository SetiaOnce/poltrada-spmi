               ...
               <div class="row">
                    <div class="col-md-12">
                        <form id="form-data" class="form" onsubmit="return false">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Nama Jenis Akreditasi : </label>
                                <div class="input-group">
                                    <input type="text" name="nama_jenis_akreditasi" class="form-control" id="nama_jenis_akreditasi" placeholder="Masukkan nama akreditasi...">
                                </div>
