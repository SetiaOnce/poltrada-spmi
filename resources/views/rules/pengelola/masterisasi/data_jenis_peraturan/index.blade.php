...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Data Jenis Peraturan</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Data Jenis Peraturan</li>
                </ol>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Data Jenis Peraturan</h4>
...
@include('rules.pengelola.masterisasi.data_jenis_peraturan.modal')

@section('js')
    @include('rules.pengelola.masterisasi.data_jenis_peraturan.script');
@stop
