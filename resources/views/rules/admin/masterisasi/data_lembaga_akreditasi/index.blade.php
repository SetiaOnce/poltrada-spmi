...
@include('rules.admin.masterisasi.data_lembaga_akreditasi.modal')

@section('js')
    @include('rules.admin.masterisasi.data_lembaga_akreditasi.script');
@stop
