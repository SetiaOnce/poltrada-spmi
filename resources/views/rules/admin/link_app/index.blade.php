...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Link Aplkasi</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Link app</li>
                </ol>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Pengaturan Link Aplikasi</h4>
...
@include('rules.admin.link_app.modal')

@section('js')
    @include('rules.admin.link_app.script')
@stop
