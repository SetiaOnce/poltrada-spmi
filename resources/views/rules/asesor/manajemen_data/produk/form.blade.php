            ...
            <div class="card-body">
                ...
                <form id="form-data" class="form" onsubmit="return false">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            <select name="jenis_produk_id" id="jenis_produk_id" class="form-control select2">
                                ...
                                <option value="AK">Jenis Produk 1</option>
                                <option value="HI">Jenis Produk 2</option>
                                <option value="HI">Jenis Produk 3</option>
                                <option value="HI">Jenis Produk 4</option>
                                <option value="HI">Jenis Produk 5</option>
                            </select>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="file_produk" id="file_produk" accept="application/pdf">
                        </div>
