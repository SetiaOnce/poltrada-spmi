...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Data Peraturan</h4>
...
@include('rules.asesor.manajemen_data.peraturan.form')
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Manajemen Data Peraturan</h4>
                </div>
                <hr>
...
@section('js')
    @include('rules.asesor.manajemen_data.peraturan.script')
@stop
