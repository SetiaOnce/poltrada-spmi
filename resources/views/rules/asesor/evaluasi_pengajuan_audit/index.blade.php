...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Evaluasi Pengajuan Audit</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);"><i class="ri-home-3-fill"></i></a></li>
                    <li class="breadcrumb-item active">Evaluasi Pengajuan Audit</li>
                </ol>
            </div>
...
<!-- end page title -->
@include('rules.asesor.evaluasi_pengajuan_audit.detail')
@include('rules.asesor.evaluasi_pengajuan_audit.temuan')
@include('rules.asesor.evaluasi_pengajuan_audit.rekomendasi')
        ...
        <div class="card">
            <div class="card-body">
                <div class=" d-sm-flex align-items-center justify-content-between">
                    <h4 class="card-title">Halaman Evaluasi Pengajuan Audit</h4>
...
@section('js')
    @include('rules.asesor.evaluasi_pengajuan_audit.script')
@stop
