        ...
        <div class="">
            <div class="panel-heading">
                <div class="section-title-heading text-center">
                    <h3 class="wow fadeInDown" data-wow-delay=".3s">SURVEY SPMI</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 wow fadeInDown" data-wow-delay=".2s">
                <a href="{{ route('survey.detail',$jenis_survey->id) }}">
                    <div class="card card-default text-center geeks">
                        <div class="card-body">
                            <img src="{{ asset($jenis_survey->gambar) }}" width="50%" height="50%" alt="">
                            <br>
                            <span style="font-size: 20px;"><strong>{{ $jenis_survey->nama_jenis_survey }}</strong></span>
                            <!-- <br>
                            <div class="">
                                <p style="font-size: 14px; color:#2C3333;"><strong>Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum </strong></p>
                            </div> -->
                        </div>
                    </div>
                </a> 
