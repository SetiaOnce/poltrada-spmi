...
<html lang="en">
    ...
    <body data-topbar="dark">
        ...
        <div id="layout-wrapper">
            ...
            @elseif (session()->get('key_level') == 'spm-unitprodi') 
                @include('layouts.sidebar.prodi_sidebar')
            @elseif (session()->get('key_level') == 'spm-asesor' ) 
                @include('layouts.sidebar.asesor_sidebar')
            @elseif (session()->get('key_level') == 'spm-staff' ) 
                @include('layouts.sidebar.pengelola_sidebar')
            @endif
            <!-- ============================================================== -->
