        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('asesor.download.manual.book') }}" data-bs-original-title="Download Manual Book" data-bs-placement="left" data-bs-toggle="tooltip"><i class="mdi mdi-download align-middle me-1"></i> Manual Book</a>
...
<script type="text/javascript">
    function _statusChance(data_id){
        var url = '{{ route("asesor.status.inbox.change", ":data_id") }}';
        ...
        $.ajax({
            ...
            success:function(response){
                if (response.success) {
                    window.location.href = "{{ route('asesor.evaluasi.audit') }}"
                }
    ...
    function _lihatSemua(){
        $.ajax({
            url: '{{ route("asesor.inbox.lihat.semua") }}',
            type: "GET",
            dataType: "JSON",
            cache: false,
            success:function(response){
