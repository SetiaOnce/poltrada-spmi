        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('prodi.download.manual.book') }}" data-bs-original-title="Download Manual Book" data-bs-placement="left" data-bs-toggle="tooltip"><i class="mdi mdi-download align-middle me-1"></i> Manual Book</a>
